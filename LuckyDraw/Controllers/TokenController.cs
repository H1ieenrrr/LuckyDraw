...
namespace LuckyDraw.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        public TokenController(ICustomer customerSvc, IConfiguration configuration)
        {
        ...
        {
            if (viewLogin != null && !string.IsNullOrEmpty(viewLogin.Phone)  && !string.IsNullOrEmpty(viewLogin.PassWord))
            {
                var customer = _customerSvc.LoginCustomer(viewLogin);
